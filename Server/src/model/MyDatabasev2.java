...
public class MyDatabasev2
{
    ...
    public MyDatabasev2(String driver, String url, String user, String pw) throws ClassNotFoundException {
      this.url = url;
      this.user = user;
      this.pw = pw;
    ...
    public MyDatabasev2(String databaseName, String user, String pw) throws ClassNotFoundException {
    ...
    public Object[] update(String sql, Object... statementElements) throws SQLException {
      this.openDatabase();
    ...
    public int[] updateAll(ArrayList<String> sqlList) throws SQLException {
      if (sqlList == null) {
        ...
        for(int i = 0; i < sqlList.size(); ++i) {
          PreparedStatement statement = this.connection.prepareStatement((String)sqlList.get(i));
